...
- Hay 6 migraciones (`0001_initial`, `0002_producto_nombre_ticket_activo`, `0003_configuracion_sucursalcliente_email_logrecordatorio`, `0004_producto_unidades_calculo`, `0005_limpia_catalogo_legacy`, `0006_limpia_historial_pedidos_prueba`); revisa el diff de cualquier migración nueva antes de aplicarla, el historial es corto y fácil de romper.
