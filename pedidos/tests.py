...
class PedidoFlowTests(TestCase):
    ...
    def test_login_crear_confirmar_e_imprimir(self):
        ...
        self.assertContains(print_response, 'class="ticket-quantity-number"')
        self.assertContains(print_response, 'class="ticket-quantity-unit"')
        ...
        self.assertContains(dashboard, "data-ticket-preview")
        self.assertContains(dashboard, 'id="ticketPreviewModal"')
        ...
        self.assertContains(dashboard, "macro-component-row")
        self.assertContains(dashboard, "Detalles Pedido 1")
        self.assertContains(dashboard, f"/admin/pedidos/{pedido.id}/eliminar/")
    ...
    def test_pantalla_pedidos_no_muestra_precios_unitarios(self):
        ...
        self.assertContains(response, '"progreso_diario"')
        self.assertNotContains(response, "Pedidos de hoy")
        self.assertNotContains(response, 'id="dailyOrderProgress"')
        self.assertNotContains(response, 'data-daily-segment="5"')
    ...
    def test_usuario_impresion_solo_ve_dashboard_e_imprime(self):
        ...
        self.assertNotContains(dashboard, "Imprimir acumulado")
        self.assertContains(dashboard, "Detalles")
    ...
    def test_cinco_pedidos_se_agrupan_y_el_sexto_se_bloquea(self):
        ...
        page = self.client.get(f"/admin/pedidos/nuevo/?sucursal={sucursal.id}")
        self.assertContains(page, '"limite_alcanzado": true')
        self.assertNotContains(page, "L&iacute;mite diario alcanzado", html=True)
        self.assertNotContains(page, 'class="order-segment segment-5 filled"')
